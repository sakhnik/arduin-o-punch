...
USB. **ОБЕРЕЖНО!** Гніздо ненадійне, може відламатися. Тоді акумулятор доведеться
виймати для заряджання.
...
діапазоні 3,0–4,2 В. На половину заряджений акумулятор має напругу десь 3,7 В.

<img alt="Battery indicator" src="images/indicator.jpg" width="512"/>
...
застосовують номери 31, 32, 33,… , 100. При підготовці дистанції у програмі
QuickEvent слід переконатися, що стартовий і фінішний контрольний пункт
позначені числами 10 і 255 відповідно.
