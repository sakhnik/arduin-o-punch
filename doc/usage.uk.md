...
[o-event](https://github.com/sakhnik/o-event).

Система змодельована за принципом SPORTIndent, проте є деякі відмінності.
...
Для успішного проходження дистанції потрібно очистити попередню відмітку перед стартом,
відмітитися на старті, потім на всіх контрольних пунктах дистанції у заданому
порядку (або й ні залежно від умов змагань), нарешті на фініші.
...
Android. Він автоматично вивантажується у програму o-event для обробки і
