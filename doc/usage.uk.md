...
станція може поставити відмітку усім, якщо тільки картки не накладаються рівно
одна над одною. При цьому звуковий сигнал свідчитиме про кількість відмічених
карток. Наприклад, «ті-ті-таа» для двох карток, «ті-ті-ті-таа» для трьох карток
і так далі. Найкраще відмітки ставити по черзі. Якщо з якоїсь причини місця на
картці для відмітки більше немає, станція повідомить «ті-ті-таа-ті», як літера
F в азбуці Морзе.
...
```
$ ./scripts/sync-clock.py --script s.txt
>> b''
>> b'\r\n'
>> b'Arduin-o-punch> '
>> b'78839083\r\n'
Before: clock=78839083 time=21:53:59
>> b'1710626040\r\n'
After: 2024-03-16 21:54:00
key 112233445566
>> b'112233445566\r\n'
recfmt 512 2
>> b'OK\r\n'
